...
from .adminfroms import PostAdminForm


class PostInline(admin.TabularInline):  # 可选择继承自admin.StackedInline以获取不用的展示形式
    fields = ('title', 'desc')
    extra = 1
    model = Post
...
class PostAdmin(BaseOwnerAdmin):
    ...
    # 多对多选择(2选1)
    filter_horizontal = ('tag',)  # 横向
    # filter_vertical = ('tag', )  # 纵向
